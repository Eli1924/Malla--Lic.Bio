...
// Verifica si se cumplen los requisitos y activa los ramos
...
// Marca como aprobado (o desmarca) al hacer clic
...
ramos.forEach(r => {
  ...
  if (contenedor) {
    contenedor.appendChild(crearCaja(r));
  }
});
actualizarMalla();
